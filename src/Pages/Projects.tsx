       ...
       <div className='bg-greyIsh flex justify-start p-8  my-14'>
        ...
        <div className='bg-greyIsh flex justify-start p-8  my-14'>
         ...
         <div className='textSection block ml-10 w-[52%]'>
          ...
          <p className='md:text-[18px] text-[15px] leading-7 font-normal'>This is my first app written in <b>React</b> using technologies such as <b>components</b>, <b>Router</b>, <b>TailwindCss</b>.</p>
         </div>
        ...
        <div className='bg-greyIsh flex justify-start p-8  my-14'>
         ...
         <div className='textSection block ml-10 w-[52%]'>
          ...
          <p className='md:text-[18px] text-[15px] leading-7 font-normal'>An interactive vinyl catalog written in <b>TypeScript</b> using <b>React</b>.</p>
         </div>
